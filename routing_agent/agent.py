...
from routing_agent.config.models import get_chat_vertex_model
...
def classify_intent(
    ...
    model = get_chat_vertex_model(region=region, temperature=0.0)
...
def route_request(
    ...
    >>> routing = route_request("Generate Terraform for a web app")
