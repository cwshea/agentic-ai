...
MODULE2_TEST_CASES = [
    # Simple single-service repositories
    {
        ...
        "expected_output": {
            ...
            "gcp_services": ["Cloud Run", "Cloud SQL", "VPC"],
        },
        "evaluation_criteria": {
            ...
            "actionability": "Provides sufficient detail for Terraform generation",
    ...
    },
    {
        ...
        "expected_output": {
            ...
            "frameworks": ["FastAPI"],
            "cache": ["Redis"],
            "gcp_services": ["Cloud Run", "Memorystore", "VPC"],
        },
        "evaluation_criteria": {
            "completeness": "Identifies FastAPI, Redis, and deployment needs",
            "accuracy": "Correctly maps dependencies to GCP services",
    ...
    # Multi-service repositories
    {
        ...
        "input": {
            ...
            "dependencies": {
                ...
                "worker": ["celery", "google-cloud-storage"],
        ...
        "expected_output": {
            ...
            "databases": ["PostgreSQL"],
            "cache": ["Redis"],
            "gcp_services": ["Cloud Run", "Cloud SQL", "Memorystore", "Cloud Storage", "Cloud Tasks", "Cloud CDN"],
        },
        "evaluation_criteria": {
    ...
    # Repositories with infrastructure-as-code
    {
        ...
        "input": {
            ...
            "terraform_resources": ["google_cloud_run_v2_service", "google_sql_database_instance"],
        },
        "expected_output": {
            "applications": 1,
            "existing_infrastructure": ["Cloud Run", "Cloud SQL"],
            "infrastructure_gaps": [],
    ...
    # Security issues
    {
        ...
        "expected_output": {
            ...
            "recommendations": [
                "Move secrets to GCP Secrets Manager",
...
MODULE2_EVALUATION_CRITERIA = {
    ...
    "actionability": "Does the analysis provide enough detail for the Terraform generation agent (Module 3) to create infrastructure without additional questions?",
