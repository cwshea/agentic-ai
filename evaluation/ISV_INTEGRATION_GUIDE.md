...
Type: Judge
Criteria: |
  Evaluate if the Terraform code includes all necessary components:
  - All required GCP resources mentioned in requirements
...
Evaluation Prompt: |
  You are evaluating Terraform infrastructure code for completeness.
...
Type: Judge
Criteria: |
  Evaluate technical correctness of the Terraform code:
  - Correct Terraform syntax and patterns
...
Evaluation Prompt: |
  You are evaluating Terraform code for technical accuracy.
  
  Task: {task_input}
  Generated Code: {task_output}
  
  Score the code from 0-100 based on:
  1. Correct Terraform syntax (30 points)
  2. Proper construct usage (30 points)
  3. Valid GCP configurations (20 points)
...
Evaluation Prompt: |
  You are evaluating Terraform code for actionability (deployment readiness).
...
Evaluation Prompt: |
  You are evaluating Terraform code for security and safety.
