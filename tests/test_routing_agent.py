...
def test_classify_infrastructure_generation():
    ...
    request = "Generate Terraform code for a web application with PostgreSQL"
...
def test_classify_gcp_infrastructure():
    """Test classification of GCP infrastructure monitoring requests."""
    request = "Check the health of my Cloud Run services in us-central1"
    
    result = classify_intent(request, verbose=False)
    
    assert result["category"] == "gcp_infrastructure"
